...
install this package first. And then type `library(Rcmdr)` to launch R commander aplication. On Tools menu choose "load plugin" and choose `rcmdrfuzzyclust`. It will restart the R Commander application.
